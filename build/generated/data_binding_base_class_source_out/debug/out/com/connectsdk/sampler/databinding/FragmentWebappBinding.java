...
public final class FragmentWebappBinding implements ViewBinding {
  ...
  private FragmentWebappBinding(@NonNull LinearLayout rootView, @NonNull Button closeWebAppButton,
      @NonNull Button joinWebAppButton, @NonNull Button launchWebAppButton,
      @NonNull Button leaveWebAppButton, @NonNull Button pinWebAppButton,
      @NonNull TextView responseMessageTextView, @NonNull Button sendJSONButton,
  ...
  public static FragmentWebappBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWebappBinding((LinearLayout) rootView, closeWebAppButton, joinWebAppButton,
          launchWebAppButton, leaveWebAppButton, pinWebAppButton, responseMessageTextView,
          sendJSONButton, sendMessageButton, unPinWebAppButton);
    }
